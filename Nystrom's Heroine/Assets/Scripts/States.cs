...
{
    void Enter(PlayerController1 controller);
    void Execute(PlayerController1 controller);
}

public class StandingState : IPlayerState
{

    public void Enter(PlayerController1 controller)
    {
        controller.currentState = this;
    }

    public void Execute(PlayerController1 controller)
    {
